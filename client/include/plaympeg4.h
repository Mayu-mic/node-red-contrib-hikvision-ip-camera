...
typedef enum tagFECCorrectType
{
    ...
    FEC_CORRECT_180 = 0x200,        //180＜ viewing mode (2-screen-split mode)
    FEC_CORRECT_360 = 0x300,        // 360＜ panoramic mode 
...
typedef struct tagFECParam
{
    ...
    unsigned int    nPlaceAndCorrect;        // Sum of installation and correction mode   (read only, invalid under SetParam mode)
    ...
    float            fWideScanOffset;        // Offset angle for 180。or 360＜ correction
